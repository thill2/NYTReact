...
const link = process.env.MONGODB_URI || "mongodb://localhost/nytreact";
...
// if no error log connection successful
...
app.post("/api/saved", function(req, res) {
  ...
  // Create article object, log error if error
  Article.create({
...
// Route for deleting saved articles, if error throw error
